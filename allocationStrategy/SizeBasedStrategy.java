...
public class SizeBasedStrategy implements AllocationStrategy {
    @Override
    public Ticket allocateSlot(Vehicle vehicle, ParkingLot parkingLot) {
        // Implement size-based allocation logic here
        Ticket ticket = null;
        main:
        for(ParkingFloor parkingFloor:parkingLot.getParkingFloorList()){
            ...
            for(ParkingSpot parkingSpot : parkingFloor.getParkingSpots()){
                if(parkingSpot.isAvailable() && parkingSpot.getSpotSize().equals(vehicle.getSuitableSpotSize())){
